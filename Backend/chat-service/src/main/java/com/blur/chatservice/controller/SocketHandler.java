...
public class SocketHandler {
    ...
    public void onCallEnd(SocketIOClient client, Map<String, Object> data, Object ack) {
        try {
            ...
            // ✅ GET THE CREATED CALL MESSAGE AND BROADCAST IT
            ...
            if (callMessage != null) {
                ...
                sendToUser(session.getCallerId(), "message_received", messagePayload);
                sendToUser(session.getReceiverId(), "message_received", messagePayload);
            }
